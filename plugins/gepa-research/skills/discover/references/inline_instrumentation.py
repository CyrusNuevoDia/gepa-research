...
Use this when the user declines the `gepa-research-agent` SDK. Paste the helper into
...
_TRACES_DIR = Path(os.environ["GEPA_RESEARCH_TRACES_DIR"]) if os.environ.get("GEPA_RESEARCH_TRACES_DIR") else None
_EXPERIMENT_ID = os.environ.get("GEPA_RESEARCH_EXPERIMENT_ID", "unknown")
